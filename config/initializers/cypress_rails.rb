...
CypressRails.hooks.before_server_start do
  ...
  #By creating a category and two products, they will populate the test database
...
CypressRails.hooks.before_server_stop do
  # Called once, at_exit
  DatabaseCleaner.clean #If we forget to clean the database, products will be added everytime we start the test
end
